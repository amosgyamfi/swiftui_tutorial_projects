//
//  ImageNetLabels.swift
//  SwiftUIFor27
//
//  ImageNet-1k class names (standard index order) used to decode PVT v2
//  classification logits. Underscores are replaced with spaces for display.
//

enum ImageNetLabels {
    /// 1000 ImageNet-1k labels in canonical index order.
    static let all: [String] = [
        ...
        "Labrador retriever", "Chesapeake Bay retriever", "German short-haired pointer", "vizsla",
